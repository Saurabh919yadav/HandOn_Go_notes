...
program begins. Whaever main does is what program does. Of course, amin wil normally
...
are missing imports or if there are unnecessary ones. This strict requireent prevents
