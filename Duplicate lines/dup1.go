...
func main() {
	...
	/*
		...
		The ke may be of any type whose values can be compared with ==,
	...
	*/
	...
	/*
		...
		most useful feature is atype called Scanner that reads input and breaks it into
	...
	for line, n := range counts {
		if n > 1 {
			...
			/*
				...
				string that specifies hor subswquent arguments should be formatted. The format
